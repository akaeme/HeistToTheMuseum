...
public class ConcentrationSiteServer {
    ...
    public static void main(String[] args) throws SocketException, SocketTimeoutException, IOException, ClassNotFoundException {
        ...
        int serverPort = Integer.parseInt(configs[1].get("ConcentrationSiteServer"));

        ConcentrationSite concentrationSite;
        IConcentrationSite concentrationSiteI;

        //communication channels
        ServerCom channel_1, channel_2;

        ClientProxy clientProxyConcentrationSite;

        //listening channel
        channel_1 = new ServerCom(serverPort);
        channel_1.start();

        concentrationSite = new ConcentrationSite(constants);
        concentrationSiteI = new IConcentrationSite(concentrationSite);
        ...
        while (true) {
            ...
            clientProxyConcentrationSite = new ClientProxy(channel_2, concentrationSiteI);
            clientProxyConcentrationSite.start();
        }

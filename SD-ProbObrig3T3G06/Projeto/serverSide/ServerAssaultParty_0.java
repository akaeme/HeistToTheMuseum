...
public class ServerAssaultParty_0 {
    ...
    public static void main(String[] args) {
     ...
     int rmiRegPortNumb = RMI_REGISTRY_PORT;
        ...
        AssaultParty engine = new AssaultParty(0, (LoggerInterface) logger_interface, rmiRegHostName);
        AssaultPartyInterface engineStub = null;
        int listeningPort = RegistryConfig.REGISTRY_ASSAULT_PARTY_PORT_0;
        ...
        GenericIO.writelnString("AP0 object was registered!");
    }

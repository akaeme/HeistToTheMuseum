...
public class ServerLogger {
    ...
    public static void main(String[] args) {
     ...
     int rmiRegPortNumb = RMI_REGISTRY_PORT;
        ...
        Logger engine = new Logger(rmiRegHostName);
        LoggerInterface engineStub = null;
        int listeningPort = RegistryConfig.REGISTRY_LOGGER_PORT;
        /* it should be set accordingly in each case */

        try {
            engineStub = (LoggerInterface) UnicastRemoteObject.exportObject((Remote) engine, listeningPort);
